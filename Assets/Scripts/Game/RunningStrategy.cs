...
{
    public class RunningStrategy : IMannequinStrategy
    {
        private Transform _playerTransform;

        public RunningStrategy()
        {
        ...
        public void Execute(Mannequin mannequin)
        {
            ...
            {
                mannequin.NavMeshAgent.speed = mannequin.WalkSpeed * 1.5f;
                mannequin.SetMovementState(false, true, false, false);
            }
        }
    }
}
